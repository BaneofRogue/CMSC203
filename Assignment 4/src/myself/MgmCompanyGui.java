 ...
 */
 ...
 Summary of Description: This class is the GUI for the management company. It contains the text fields, buttons, and the plot of the management company.
 Although I do not like to edit files when suggested not to, I had to edit the code in order to make it work.
 the function addProp()'s return value was changed from void to Rectangle. 
 More documentation is on the function itself.
 Due Date: 04/11/2025
...
public class MgmCompanyGui extends Application {
	...
	// changed the function to return rectangle rather than void. 
	// the param propRectangle was/is pretty much useless.
	// 
	...
	private void addProp() {
		if (!isPropertyFieldEmpty()) {
			...
			/* since propRectangle was null before, plotFrame.getChildren().remove(propRectangle) was completely useless,
			 because the object was null.
			 Now, since drawPropertyPlot actually returns a value,
			 propRectangle is no longer null, and can be successfully removed.
			 *** I dislike to edit files when suggested not to, but in this case it really hurt my heart to see such code. ***
			*/
